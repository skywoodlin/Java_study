package NIO.FromYDYM;

/**
 * clone from 芋道源码
 * https://github.com/YunaiV/netty/tree/f7016330f1483021ef1c38e0923e1c8b7cef0d10/example/src/main/java/io/netty/example/yunai/nio
 */
...
public class NioClient_YDYM{
    ...
    public NioClient_YDYM() throws IOException, InterruptedException {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        NioClient_YDYM client = new NioClient_YDYM();
        for (int i = 0; i < 30; i++) {
            client.send("nihao: " + i);
            Thread.sleep(1000L);
        }
